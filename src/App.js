    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/capability-building-programs/ic-agile" element={<IcAgile />}></Route>
          ...
          <Route path="/capability-building-programs/safe" element={<Safe />}></Route>
          ...
          <Route path="/capability-building-programs/dasa" element={<Dasa/>}></Route>
          <Route path="/assessments" element={<Assessments/>}></Route>
          <Route path="/dasa-flipbook" element={<DasaFlipbook/>}></Route>
          <Route path="/experiential-learning-programs" element={<ExperientialLeraningPrograms/>}></Route>
          ...
          <Route path="/agile-transformation-a-bloo-or-a-dom" element={<Blog1/>}></Route>
          <Route path="/lessons-in-leadership-succession-planning" element={<Blog2/>}></Route>
          <Route path="/2019-extending-the-horizons" element={<Blog3/>}></Route>
          <Route path="/how-to-As-your-limiting-benefits" element={<Blog4/>}></Route>
          <Route path="/why-unlearning-studio-meetup" element={<Blog5/>}></Route>
          <Route path="/self-reflection" element={<Blog6/>}></Route>
          <Route path="/unlearning-is-a-challenge-or-opportunity" element={<Blog7/>}></Route>
          ...
          <Route path="/self-assessment-contionous" element={<Blog12/>}></Route>
          <Route path="/feed-back-to-feed-forward" element={<Blog13/>}></Route>
          <Route path="/agile-to-agility" element={<Blog14/>}></Route>
          <Route path="/reusable-templates" element={<ReusableTemplates/>}></Route>
          <Route path="/assessments" element={<Assessments/>}></Route>
          <Route path="/work-books" element={<Workbook/>}></Route>
          <Route path="/custom-slider" element={<CustomSlider/>}></Route>
          <Route path="/course-schedule" element={<CourseTimingUpdate/>}></Route>
          <Route path="/modal-image-upload" element={<CustomModalImageUpload/>}></Route>
          <Route path="/e-learning-programs" element={<ELearning/>}></Route>
          <Route path="/e-learning/agile-fundamentals" element={<AgileFundamentals/>}></Route>
          <Route path="/e-learning/agile-coaching-fundamentals" element={<AgileCoachingFundamentals/>}></Route>
          ...
          <Route path="/agile-team-assessment" element={<AgileTeamAssessment/>}></Route>
          <Route path="/agile-coach-assessment" element={<AgileCoachingAssessment/>}></Route>
          <Route path="/agile-Leadership-assessment" element={<AgileLeadershipAssessment/>}></Route>
          <Route path="/cookies-policy" element={<CookiePolicy/>}></Route>
          <Route path="/success" element={<Success/>}></Route>
          <Route path="/promotional-coaching-image-upload" element={<PromotionalVideoUpload/>}></Route>
          <Route path="/promotional-mentoring-image-upload" element={<MentoringPromotion/>}></Route>
        </Routes>
        <Footer />
      </Router>
    </div>
