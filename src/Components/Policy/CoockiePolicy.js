      ...
      >
        <Container>
          <Row>
            <Col md={12}>
              <div className="">
                <h2 className="text-center text-white">Cookie Policy</h2>
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb justify-content-center">
                    ...
                    <li className="breadcrumb-item">Cookie Policy</li>
                  </ol>
                </nav>
              </div>
            </Col>
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              ...
              <ul>
                  ...
                  <li>-Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Digital Agility Institute, that is responsible for your information under this Cookie Policy.</li>
                  <li>-Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Digital Agility Institute and use the services.</li>
                  ...
                  <li>-Service: refers to the service provided by Digital Agility Institute as described in the relative terms (if available) and on this platform.</li>
                  ...
                  <li>  -Website: Digital Agility Institute."’s" site, which can be accessed via this URL: http://digitalagilityinstitute.com/contact-us</li>
                  <li>  -You: a person or entity that is registered with Digital Agility Institute to use the Services.</li>
              </ul>
              <h3>Introduction</h3>
              <p>This Cookie Policy explains how Digital Agility Institute and its affiliates (collectively "Digital Agility Institute", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation http://digitalagilityinstitute.com/contact-us and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>
              ...
              <p>We use first party and/or third party cookies on our website for various purposes such as:</p>
                ...
                <h3>What type of cookies does Digital Agility Institute use?</h3>
