...
const HomeAssessments = () => {
  const associations = [
    { id: 1, imgurl: img1, alt: "", link:"/agile-team-assessment" },
    { id: 2, imgurl: img2, alt: "", link:"/agile-coaching-assessment" },
    { id: 3, imgurl: img3, alt: "", link:"/agile-leadership-assessment" },
  ];
...
export default HomeAssessments;
